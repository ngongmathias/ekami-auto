...
4. If asked about specific car availability or pricing, suggest they check the website or contact directly
...
function getMockResponse(userMessage: string): string {
  ...
  if (message.includes('rent') || message.includes('rental')) {
    return "We offer flexible car rental services in Douala! 🚗 Our rental process is simple:\n\n1. Browse available cars on our website\n2. Select your dates\n3. Complete booking\n4. Pick up your car!\n\nPrices vary by car type and duration. Would you like to see our available cars?";
  }
  
  if (message.includes('buy') || message.includes('purchase')) {
    return "Looking to buy a car? Great choice! 🎉 We have both new and used vehicles available. You can:\n\n• Browse our inventory online\n• Schedule a test drive\n• Get financing options\n• Trade in your old car\n\nWhat type of car are you interested in?";
  }
